...
export default function Pricing() {
  ...
  return (
    <section id='pricing' className="w-full mx-auto py-20 text-white relative overflow-hidden min-h-screen flex flex-col md:flex-row items-center justify-between">
      <div className="w-full md:max-w-[80%] mx-auto px-4 sm:px-2 lg:px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {plans.map((plan, index) => (
            ...
            >
              {plan.popular && (
                <div className="absolute top-0 right-0 bg-lime-400/80 text-black px-3 py-1 text-xs font-bold rounded-tr-xl">
                  POPULAR
                </div>
              )}
